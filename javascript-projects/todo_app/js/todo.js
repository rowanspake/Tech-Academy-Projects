...
function get_todos() {
    /*this creates an array of tasts that are inputed*/
    var todos = new Array;
...
/*This function adds the inputed taask to the get_todos function array*/
function add() {
...
/*this will keep the inputs displaued permanently on the screen*/
show();

/*this creates the functionality of removing a todo item fromt he array */
function remove() {
    var id = this.getAttribute('id');
    var todos = get_todos();
    todos.splice(id, 1);
    localStorage.setItem('todo', JSON.stringify(todos));
    /*this looks inthe show() how to display a removed item on the screen */
    show();
